...
- [ ] При выполнении команды `node 03-files-in-folder` в корневом каталоге репозитория в консоль выводится информация о файлах содержащихся непосредственно внутри **_03-files-in-folder/secret-folder_**. Данные должны быть выведены в формате <имя файла>-<расширение файла>-<вес файла>. Пример: `example - txt - 128.369kb` (округлять не нужно, конвертация в кб по желанию!)
- [ ] Информация должна выводиться только для файлов содержащихся в **_03-files-in-folder/secret-folder_**. Наличие информации о директориях считается ошибкой.
